const portfolioData = {
  ...
  projects: [
    {
      ...
      liveUrl: "#",
      githubUrl: "",
      note: "Research project for Dept. of Plant & Soil Sciences, Texas Tech. Repository not public.",
    },
    {
      ...
      liveUrl: "#",
      githubUrl: "",
      note: "Research project completed as part of university lab work. Public repository not available.",
    },
    {
      tag: "Data Science Project",
      title: "Geospatial Soil Data Mapping",
      description:
        "Applied Python and R geospatial workflows, including kriging interpolation, to map global soil nutrient distributions from the WoSIS dataset for richer scientific visualization and analysis.",
      stack: ["Python", "R", "Geospatial Data"],
      liveUrl: "#",
      githubUrl: "",
      note: "Internship work completed for CASFER. Repository is not public.",
    },
    {
      tag: "ML Project",
      title: "Peptide Sequence Absorbance Prediction",
      description:
        "Developed Random Forest, XGBoost, and Gradient Boosting models to predict UV-Vis absorbance for more than 20,000 peptide sequences, helping streamline experimental validation workflows.",
      stack: ["Random Forest", "XGBoost", "Data Science"],
      liveUrl: "#",
      githubUrl: "",
      note: "Internship work completed for CASFER. Repository is not public.",
    },
  ...
  githubProjects: [
    {
      name: "ai-arena",
      url: "https://github.com/Aartikkk/ai-arena",
      language: "JavaScript",
      summary:
        "A prompt-powered offline web boxing game where AI personas like ChatGPT, Claude, Gemini, and Perplexity battle through themed challenge rounds such as Coding, Writing, Creativity, Logic, Research, and Persuasion. The project turns abstract AI capabilities into game mechanics, animated attacks, crowd reactions, and a switchable classic-versus-boxing-ring presentation.",
      extraLinks: [],
    },
    {
      name: "MonocularVO",
      url: "https://github.com/Aartikkk/CS4331-005-Final-Project",
      language: "Python",
      summary:
        "A modular monocular visual odometry system built from scratch for an autonomous driving course. The pipeline combines ORB feature extraction, Essential-matrix pose initialization, PnP reprojection-error refinement, and Kalman-based temporal smoothing to produce robust trajectory estimates on KITTI driving data.",
      extraLinks: [
        {
          label: "Read Project Report",
          url: "assets/docs/monocular-vo-report.pdf",
        },
      ],
    },
  ],
